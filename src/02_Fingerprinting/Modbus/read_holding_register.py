...
def read_holding_register(ip, uid):
    ...
    ans = c.sr1(ModbusADU(transId=getTransId(),unitId=int(uid))/ModbusPDU03_Read_Holding_Registers(startAddr=int(startAddr,16),quantity=int(quantity,16)),timeout=timeout, verbose=0)
